          ...
          <div className={styles.content}>
            <div className={styles.apiCard}>
              ...
              <div className={styles.keySection}>
                <div className={styles.keyValue}>sk-kdjlkjafij921uij</div>
              ...
              <div className={styles.statusSection}>
                ...
                <div>
                  ...
                  <input type="radio" name="status" value="사용 안함" style={{ marginLeft: '20px' }} /> 사용 안함
                </div>
              </div>
      ...
      <div className={styles.dashboard}>
        <div className={styles.sidebar}>
          ...
          <ul className={styles.menu}>
            <li className={currentPage === 'dashboard' ? styles.active : ''} onClick={() => setCurrentPage('dashboard')}>Dashboard</li>
            <li className={currentPage === 'apiManagement' ? styles.active : ''} onClick={() => setCurrentPage('apiManagement')}>API 관리</li>
            <li>보안 및 인증</li>
            <li>알림 설정</li>
          </ul>
        </div>
